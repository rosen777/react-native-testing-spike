...
test('forwards remaning props to the underlying TextInput', () => {
    const onChangeTextMock = jest.fn();
   
    const { getByTestId } = render(<TextField label="Test Label" passedProp="yes" onChangeText={onChangeTextMock} />)
